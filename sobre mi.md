...
1. Aprendí que es un repositorio, el cual es una carpeta donde contiene el historial de cada modificación 
2. Como crear un repositorio
3. Porque es "master" y no "main"
4. Como crear una cuenta en github
